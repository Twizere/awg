	...
	switch ($_POST['act']) {
		case 'save':
			...
			if (empty($input_errors)) {
				...
				// Save was successful
				header('Location: /awg/vpn_wg_peers.php');
			}
...
$pglinks = array("", "/awg/vpn_wg_tunnels.php", "/awg/vpn_wg_peers.php", "@self");

$tab_array = array();
$tab_array[] = array(gettext("Tunnels"), false, "/awg/vpn_wg_tunnels.php");
$tab_array[] = array(gettext("Peers"), true, "/awg/vpn_wg_peers.php");
